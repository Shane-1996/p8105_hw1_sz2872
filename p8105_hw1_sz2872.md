...
```
    ...
    ##      <dbl> <lgl>   <chr>    <fct>     
    ##  1 -0.685  FALSE   my       small     
    ##  2 -0.677  FALSE   cat      small     
    ##  3  0.0498 TRUE    names    small     
    ##  4  0.295  TRUE    potato   mid       
    ##  5  2.49   TRUE    coke     mid       
    ##  6  0.328  TRUE    cola     mid       
    ##  7  0.355  TRUE    is       mid       
    ##  8 -1.19   FALSE   a        large     
    ##  9  0.553  TRUE    black    large     
    ## 10  1.15   TRUE    kitty    large
